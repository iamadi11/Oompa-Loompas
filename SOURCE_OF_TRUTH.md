...
- Core shipped: Deal CRUD, payment milestones, deliverable tracking, dashboard, invoices, proposal links, pipeline strip, next-action prompt, deal duplication, portfolio CSV export (deals, payment milestones, deliverables)
- Remaining: email-to-deal capture, scheduled reminders, client profiles
