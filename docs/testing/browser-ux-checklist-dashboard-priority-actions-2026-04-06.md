...
**Date:** 2026-04-06  
**Latest MCP run:** 2026-04-06 (Cursor browser MCP, **repeat**) — `/` on **3005** after **`.next` delete** + dev restart (had **`./958.js`** missing chunk **500** before fix): **What to do next**, **Financial summary**, **Recent deals**; **Revenue** `states: [current]`; **Pass**.  
