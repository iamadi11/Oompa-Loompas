...
function delayStep(reduce: boolean | null, step: number) {
  return reduce ? 0 : step * 0.09
}
      ...
      <main id="main-content" className="flex-1">
        <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-28">
          <motion.p
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.45, delay: delayStep(reduce, 0) }}
          >
            {APP_TAGLINE}
          </motion.p>
          <motion.h1
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.55, delay: delayStep(reduce, 1) }}
          >
          ...
          <motion.p
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: delayStep(reduce, 2) }}
          >
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.48, delay: delayStep(reduce, 3) }}
          >
            <motion.div {...(!reduce ? { whileHover: { scale: 1.02 }, whileTap: { scale: 0.98 } } : {})}>
              <Link
                href="/login"
            ...
            <ul className="mt-10 grid gap-8 sm:grid-cols-3">
              {[
                ...
                <motion.li
                  ...
                  transition={{ duration: 0.45, delay: reduce ? 0 : idx * 0.12 }}
                >
