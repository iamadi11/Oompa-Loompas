    ...
    <div className="flex flex-col items-start gap-8 py-10 sm:py-14 max-w-xl">
      ...
      >
        <div>
          ...
          <p
            id="overview-error-body"
            className="mt-4 text-base sm:text-lg text-stone-600 leading-relaxed"
          >
            Your deals are not gone — we could not reach the server. Check your connection, confirm
