      ...
      {actions.map((action, i) => (
        ...
        >
          {action.kind === 'overdue_payment' ? (
            ...
            <Link
              href={`/deals/${action.dealId}`}
              className="flex flex-col gap-0.5 rounded-xl border border-amber-700/40 bg-surface-raised px-3 py-3 text-left shadow-sm transition duration-200 motion-reduce:transition-none hover:border-amber-600/60 hover:shadow-card focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-2 focus-visible:ring-offset-canvas"
            >
              <span className="text-sm font-semibold text-stone-900">
